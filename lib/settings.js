...
// V: python-linters.path.customToml
const sCustomToml = [packageName, settingCategoryPath, 'customToml'].join('.');
...
module.exports = {getS, setS, rawTempFolderPath, sPythonPath, sPythonExecutable, sConfig, sCustomToml, sLintTriggerFlake8, sLintTriggerMypy, sLintTriggerPydocstyle, sLintTriggerPylint, isLintsOnChange, packageName, settingCategoryPath};
